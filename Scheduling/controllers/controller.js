...
async function sendMail(req, res) {
  ...
  try {
    ...
    schedules.forEach((schedule) => {
      ...
      // Eğer repeat true ise, çalıştığı süre boyunca günleri kontrol edip belirtilen saatte mail gönderilir.
      if (repeat) {
        cron.schedule(
          ...
          () => {
            ...
            pool.query(
              "UPDATE MAIL_SCHEDULES SET date = date + interval '1 week' WHERE id = $1",
              [id]
            );
